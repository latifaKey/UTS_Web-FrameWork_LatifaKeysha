...
<head>
    ...
    <title>Daftar - Aplikasi Booking Lapangan Olahraga</title>
    <!-- Bootstrap CSS -->
...
<body>
    <div class="register-container">
        <div class="register-form animate__animated animate__fadeIn">
            ...
            <div class="register-body">
                ...
                <form action="{{ route('register') }}" method="POST" id="registerForm">
                    ...
                    <div class="mb-3 animate__animated animate__fadeInUp animate__delay-1s">
                        ...
                        <div class="form-icon">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required autofocus placeholder="Masukkan nama lengkap anda..." autocomplete="name">
                        </div>
                        @error('name')
                    ...
                    <div class="mb-3 animate__animated animate__fadeInUp animate__delay-2s">
                        ...
                        <div class="form-icon">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" required placeholder="Masukkan email anda..." autocomplete="email">
                        </div>
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3 animate__animated animate__fadeInUp animate__delay-3s">
                        ...
                        <div class="form-icon">
                            ...
                            <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" required placeholder="Buat password anda..." autocomplete="new-password">
                        </div>
                        @error('password')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-4 animate__animated animate__fadeInUp animate__delay-4s">
                        ...
                        <div class="form-icon">
                            ...
                            <input type="password" class="form-control" id="password_confirmation" name="password_confirmation" required placeholder="Konfirmasi password anda..." autocomplete="new-password">
                        </div>
                    </div>

                    <div class="d-grid gap-2 mt-4 animate__animated animate__fadeInUp animate__delay-5s">
                ...
                <div class="text-center mt-4 animate__animated animate__fadeIn animate__delay-5s">
                    <p class="mb-0">Sudah punya akun?
                        <a href="{{ route('login') }}" class="text-decoration-none text-primary fw-medium link-animation">
                            Login di sini
                        </a>
                    </p>
                </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        registerForm.addEventListener('submit', function(e) {
            ...
            registerButton.querySelector('.fas').style.display = 'none';
